	...
	<div id="wrapper">
		...
		<div class="w1">
			...
			<main id="main" class="bg-grey">
				<!-- start of page-header -->
				<div class="page-header text-center bg-img-full" style="background-image: url('bg.png');">
					...
					<div class="row mar-bottom-md">
						<div class="col-xs-12 pad-top-lg">
							...
							<header class="main-heading-main text-center row">
								<div class="col-xs-12">
									<h2 class="heading">Submit your idea!</h2>
									<p>You have this idea to build, that will change the world? Come let's build the awesome software together</p>
								</div>
...
@endif
							<form id="contactForm2" action="/submit-idea" method="post">
                              {{ csrf_field() }}
								<!-- start of contact-form -->
								<div class="contact-form">
									<div class="row">
										<div class="col-xs-12">
											<input type="text" class="form-control" placeholder="What would you call it?*" id="title" name="title">
										</div>
									</div>
									<div class="row">
										<div class="col-xs-12">
											<textarea cols="30" rows="10" class="form-control" placeholder="Give us a description ...*" id="description" name="description"></textarea>
										</div>
									</div>
									<div class="row">
										<div class="col-xs-12">
